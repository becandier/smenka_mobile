...
mixin _$VerifyState {
  ...
  int get hashCode => Object.hash(
      runtimeType, email, code, status, cooldownSeconds, isResending, error);

  @override
  String toString() {
    return 'VerifyState(email: $email, code: $code, status: $status, cooldownSeconds: $cooldownSeconds, isResending: $isResending, error: $error)';
  }
}
...
extension VerifyStatePatterns on VerifyState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String email, String code, FeatureStatus status,
            int cooldownSeconds, bool isResending, String? error)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _VerifyState() when $default != null:
        return $default(_that.email, _that.code, _that.status,
            _that.cooldownSeconds, _that.isResending, _that.error);
      case _:
        return orElse();
    }
  }
