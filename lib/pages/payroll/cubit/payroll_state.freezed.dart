...
mixin _$PayrollState {
  ...
  $PayrollStateCopyWith<PayrollState> get copyWith =>
      _$PayrollStateCopyWithImpl<PayrollState>(
          this as PayrollState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PayrollState &&
            (identical(other.payroll, payroll) || other.payroll == payroll) &&
            const DeepCollectionEquality()
                .equals(other.membersByUserId, membersByUserId) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      payroll,
      const DeepCollectionEquality().hash(membersByUserId),
      preset,
      customFrom,
      customTo);
...
abstract mixin class $PayrollStateCopyWith<$Res> {
  factory $PayrollStateCopyWith(
          PayrollState value, $Res Function(PayrollState) _then) =
      _$PayrollStateCopyWithImpl;
  @useResult
  $Res call(
      {SectionData<Payroll> payroll,
      Map<String, Member> membersByUserId,
      PeriodPreset? preset,
      DateTime? customFrom,
      DateTime? customTo});
...
/// @nodoc
class _$PayrollStateCopyWithImpl<$Res> implements $PayrollStateCopyWith<$Res> {
    ...
    return _then(_self.copyWith(
      payroll: null == payroll
          ...
          : payroll // ignore: cast_nullable_to_non_nullable
              as SectionData<Payroll>,
      membersByUserId: null == membersByUserId
          ? _self.membersByUserId
          : membersByUserId // ignore: cast_nullable_to_non_nullable
...
extension PayrollStatePatterns on PayrollState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PayrollState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _PayrollState() when $default != null:
        return $default(_that.payroll, _that.membersByUserId, _that.preset,
            _that.customFrom, _that.customTo);
      case _:
        return orElse();
    }
  }
...
class _PayrollState extends PayrollState {
  const _PayrollState(
      {this.payroll = const SectionData<Payroll>(),
      final Map<String, Member> membersByUserId = const <String, Member>{},
      this.preset = PeriodPreset.month,
      this.customFrom,
      this.customTo})
      : _membersByUserId = membersByUserId,
        super._();

  @override
  @JsonKey()
  final SectionData<Payroll> payroll;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PayrollStateCopyWith<_PayrollState> get copyWith =>
      __$PayrollStateCopyWithImpl<_PayrollState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PayrollState &&
            (identical(other.payroll, payroll) || other.payroll == payroll) &&
            const DeepCollectionEquality()
                .equals(other._membersByUserId, _membersByUserId) &&
            (identical(other.preset, preset) || other.preset == preset) &&
            (identical(other.customFrom, customFrom) ||
                other.customFrom == customFrom) &&
            (identical(other.customTo, customTo) ||
  ...
  int get hashCode => Object.hash(
      runtimeType,
      payroll,
      const DeepCollectionEquality().hash(_membersByUserId),
      preset,
      customFrom,
      customTo);
...
/// @nodoc
abstract mixin class _$PayrollStateCopyWith<$Res>
    implements $PayrollStateCopyWith<$Res> {
  factory _$PayrollStateCopyWith(
          _PayrollState value, $Res Function(_PayrollState) _then) =
      __$PayrollStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {SectionData<Payroll> payroll,
