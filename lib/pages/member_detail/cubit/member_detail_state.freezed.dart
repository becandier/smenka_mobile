...
mixin _$MemberDetailState {
  ...
  SectionData<List<MemberChecklistOverride>> get overrides;
  SectionData<List<EffectiveChecklistTemplate>> get effective;
  SectionData<List<OrganizationRole>> get availableRoles;
  Set<String> get pendingTemplateIds;
  ...
  $MemberDetailStateCopyWith<MemberDetailState> get copyWith =>
      _$MemberDetailStateCopyWithImpl<MemberDetailState>(
          this as MemberDetailState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MemberDetailState &&
            ...
            (identical(other.availableRoles, availableRoles) ||
                other.availableRoles == availableRoles) &&
            const DeepCollectionEquality()
                .equals(other.pendingTemplateIds, pendingTemplateIds) &&
  ...
  int get hashCode => Object.hash(
      ...
      effective,
      availableRoles,
      const DeepCollectionEquality().hash(pendingTemplateIds),
      actionStatus,
      actionError);
...
abstract mixin class $MemberDetailStateCopyWith<$Res> {
  factory $MemberDetailStateCopyWith(
          MemberDetailState value, $Res Function(MemberDetailState) _then) =
      _$MemberDetailStateCopyWithImpl;
  @useResult
  $Res call(
      {Member member,
...
class _$MemberDetailStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? pendingTemplateIds = null,
    ...
    return _then(_self.copyWith(
      ...
      overrides: null == overrides
          ...
          : overrides // ignore: cast_nullable_to_non_nullable
              as SectionData<List<MemberChecklistOverride>>,
      ...
      availableRoles: null == availableRoles
          ? _self.availableRoles
          : availableRoles // ignore: cast_nullable_to_non_nullable
              as SectionData<List<OrganizationRole>>,
      pendingTemplateIds: null == pendingTemplateIds
          ? _self.pendingTemplateIds
          : pendingTemplateIds // ignore: cast_nullable_to_non_nullable
              as Set<String>,
  ...
  @pragma('vm:prefer-inline')
  $SectionDataCopyWith<List<MemberChecklistOverride>, $Res> get overrides {
    return $SectionDataCopyWith<List<MemberChecklistOverride>, $Res>(
        _self.overrides, (value) {
  ...
  @pragma('vm:prefer-inline')
  $SectionDataCopyWith<List<EffectiveChecklistTemplate>, $Res> get effective {
    return $SectionDataCopyWith<List<EffectiveChecklistTemplate>, $Res>(
        _self.effective, (value) {
  ...
  @pragma('vm:prefer-inline')
  $SectionDataCopyWith<List<OrganizationRole>, $Res> get availableRoles {
    return $SectionDataCopyWith<List<OrganizationRole>, $Res>(
        _self.availableRoles, (value) {
...
extension MemberDetailStatePatterns on MemberDetailState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MemberDetailState value)? $default, {
    ...
    switch (_that) {
      case _MemberDetailState() when $default != null:
        return $default(
            ...
            _that.overrides,
            _that.effective,
            _that.availableRoles,
            _that.pendingTemplateIds,
            _that.actionStatus,
            _that.actionError);
      case _:
        return orElse();
...
class _MemberDetailState extends MemberDetailState {
  const _MemberDetailState(
      ...
      this.viewerRole,
      this.overrides = const SectionData<List<MemberChecklistOverride>>(),
      this.effective = const SectionData<List<EffectiveChecklistTemplate>>(),
      this.availableRoles = const SectionData<List<OrganizationRole>>(),
      final Set<String> pendingTemplateIds = const <String>{},
      this.actionStatus = FeatureStatus.initial,
      this.actionError})
      : _pendingTemplateIds = pendingTemplateIds,
        super._();
  ...
  @override
  @JsonKey()
  final SectionData<List<MemberChecklistOverride>> overrides;
  @override
  @JsonKey()
  final SectionData<List<EffectiveChecklistTemplate>> effective;
  @override
  @JsonKey()
  final SectionData<List<OrganizationRole>> availableRoles;
  final Set<String> _pendingTemplateIds;
  @override
  @JsonKey()
  Set<String> get pendingTemplateIds {
    if (_pendingTemplateIds is EqualUnmodifiableSetView)
      return _pendingTemplateIds;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MemberDetailStateCopyWith<_MemberDetailState> get copyWith =>
      __$MemberDetailStateCopyWithImpl<_MemberDetailState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _MemberDetailState &&
            (identical(other.member, member) || other.member == member) &&
            (identical(other.viewerRole, viewerRole) ||
                other.viewerRole == viewerRole) &&
            (identical(other.overrides, overrides) ||
            ...
            (identical(other.availableRoles, availableRoles) ||
                other.availableRoles == availableRoles) &&
            const DeepCollectionEquality()
                .equals(other._pendingTemplateIds, _pendingTemplateIds) &&
            (identical(other.actionStatus, actionStatus) ||
                other.actionStatus == actionStatus) &&
            (identical(other.actionError, actionError) ||
                other.actionError == actionError));
  ...
  int get hashCode => Object.hash(
      ...
      effective,
      availableRoles,
      const DeepCollectionEquality().hash(_pendingTemplateIds),
      actionStatus,
      actionError);
...
/// @nodoc
abstract mixin class _$MemberDetailStateCopyWith<$Res>
    implements $MemberDetailStateCopyWith<$Res> {
  factory _$MemberDetailStateCopyWith(
          _MemberDetailState value, $Res Function(_MemberDetailState) _then) =
      __$MemberDetailStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {Member member,
