...
mixin _$LocationsState {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, locations, actionStatus, actionError);
...
class _$LocationsStateCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $SectionDataCopyWith<List<WorkLocation>, $Res> get locations {
    return $SectionDataCopyWith<List<WorkLocation>, $Res>(_self.locations,
        (value) {
...
extension LocationsStatePatterns on LocationsState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(SectionData<List<WorkLocation>> locations,
    ...
    switch (_that) {
      case _LocationsState() when $default != null:
        return $default(_that.locations, _that.actionStatus, _that.actionError);
      case _:
        return orElse();
    }
  }
...
class _LocationsState implements LocationsState {
  const _LocationsState(
      {this.locations = const SectionData<List<WorkLocation>>(),
      this.actionStatus = FeatureStatus.initial,
      this.actionError});

  @override
  @JsonKey()
  final SectionData<List<WorkLocation>> locations;
  @override
  @JsonKey()
