...
extension DebugStatePatterns on DebugState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DebugState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Flavors? flavor, bool? isDeviceAccess,
            String? errorMessage, FeatureStatus status)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _DebugState() when $default != null:
        return $default(_that.flavor, _that.isDeviceAccess, _that.errorMessage,
            _that.status);
      case _:
        return orElse();
    }
