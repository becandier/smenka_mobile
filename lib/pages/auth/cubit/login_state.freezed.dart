...
mixin _$LoginState {
  ...
  int get hashCode => Object.hash(
      runtimeType, mode, email, password, name, obscurePassword, status, error);

  @override
  String toString() {
    return 'LoginState(mode: $mode, email: $email, password: $password, name: $name, obscurePassword: $obscurePassword, status: $status, error: $error)';
  }
}
...
extension LoginStatePatterns on LoginState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(AuthMode mode, String email, String password, String name,
            bool obscurePassword, FeatureStatus status, String? error)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LoginState() when $default != null:
        return $default(_that.mode, _that.email, _that.password, _that.name,
            _that.obscurePassword, _that.status, _that.error);
      case _:
        return orElse();
    }
  }
