...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Task<T>);
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( TaskSuccess<T> value)?  success,TResult Function( TaskFailure<T> value)?  failure,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( TaskSuccess<T> value)  success,required TResult Function( TaskFailure<T> value)  failure,}){
final _that = this;
switch (_that) {
case TaskSuccess():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( TaskSuccess<T> value)?  success,TResult? Function( TaskFailure<T> value)?  failure,}){
final _that = this;
switch (_that) {
case TaskSuccess() when success != null:
return success(_that);case TaskFailure() when failure != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T data)?  success,TResult Function( ApiException error)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case TaskSuccess() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T data)  success,required TResult Function( ApiException error)  failure,}) {final _that = this;
switch (_that) {
case TaskSuccess():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T data)?  success,TResult? Function( ApiException error)?  failure,}) {final _that = this;
switch (_that) {
case TaskSuccess() when success != null:
return success(_that.data);case TaskFailure() when failure != null:
return failure(_that.error);case _:
...
/// @nodoc
abstract mixin class $TaskSuccessCopyWith<T,$Res> implements $TaskCopyWith<T, $Res> {
...
/// @nodoc
abstract mixin class $TaskFailureCopyWith<T,$Res> implements $TaskCopyWith<T, $Res> {
