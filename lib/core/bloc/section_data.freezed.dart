...
mixin _$SectionData<T> {
  ...
  $SectionDataCopyWith<T, SectionData<T>> get copyWith =>
      _$SectionDataCopyWithImpl<T, SectionData<T>>(
          this as SectionData<T>, _$identity);
...
extension SectionDataPatterns<T> on SectionData<T> {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SectionData<T> value)? $default, {
...
class _SectionData<T> extends SectionData<T> {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SectionDataCopyWith<T, _SectionData<T>> get copyWith =>
      __$SectionDataCopyWithImpl<T, _SectionData<T>>(this, _$identity);
...
/// @nodoc
abstract mixin class _$SectionDataCopyWith<T, $Res>
    implements $SectionDataCopyWith<T, $Res> {
  factory _$SectionDataCopyWith(
          _SectionData<T> value, $Res Function(_SectionData<T>) _then) =
