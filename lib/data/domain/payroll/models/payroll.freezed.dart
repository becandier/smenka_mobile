...
mixin _$PayrollPeriod {
  ...
  $PayrollPeriodCopyWith<PayrollPeriod> get copyWith =>
      _$PayrollPeriodCopyWithImpl<PayrollPeriod>(
          this as PayrollPeriod, _$identity);
...
abstract mixin class $PayrollPeriodCopyWith<$Res> {
  factory $PayrollPeriodCopyWith(
          PayrollPeriod value, $Res Function(PayrollPeriod) _then) =
      _$PayrollPeriodCopyWithImpl;
  @useResult
...
extension PayrollPeriodPatterns on PayrollPeriod {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PayrollPeriod value)? $default, {
...
class _PayrollPeriod implements PayrollPeriod {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PayrollPeriodCopyWith<_PayrollPeriod> get copyWith =>
      __$PayrollPeriodCopyWithImpl<_PayrollPeriod>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PayrollPeriod &&
            (identical(other.dateFrom, dateFrom) ||
                other.dateFrom == dateFrom) &&
            (identical(other.dateTo, dateTo) || other.dateTo == dateTo));
  }
...
/// @nodoc
abstract mixin class _$PayrollPeriodCopyWith<$Res>
    implements $PayrollPeriodCopyWith<$Res> {
  factory _$PayrollPeriodCopyWith(
          _PayrollPeriod value, $Res Function(_PayrollPeriod) _then) =
      __$PayrollPeriodCopyWithImpl;
  @override
  @useResult
  $Res call({DateTime? dateFrom, DateTime? dateTo});
}
...
mixin _$PayrollItem {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PayrollItemCopyWith<PayrollItem> get copyWith =>
      _$PayrollItemCopyWithImpl<PayrollItem>(this as PayrollItem, _$identity);
...
abstract mixin class $PayrollItemCopyWith<$Res> {
  factory $PayrollItemCopyWith(
          PayrollItem value, $Res Function(PayrollItem) _then) =
      _$PayrollItemCopyWithImpl;
  @useResult
  $Res call(
      {String userId,
      String userName,
...
/// @nodoc
class _$PayrollItemCopyWithImpl<$Res> implements $PayrollItemCopyWith<$Res> {
...
extension PayrollItemPatterns on PayrollItem {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PayrollItem value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _PayrollItem implements PayrollItem {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PayrollItemCopyWith<_PayrollItem> get copyWith =>
      __$PayrollItemCopyWithImpl<_PayrollItem>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PayrollItem &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.userName, userName) ||
                other.userName == userName) &&
            (identical(other.workedSeconds, workedSeconds) ||
...
/// @nodoc
abstract mixin class _$PayrollItemCopyWith<$Res>
    implements $PayrollItemCopyWith<$Res> {
  factory _$PayrollItemCopyWith(
          _PayrollItem value, $Res Function(_PayrollItem) _then) =
      __$PayrollItemCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String userId,
...
/// @nodoc
class __$PayrollItemCopyWithImpl<$Res> implements _$PayrollItemCopyWith<$Res> {
...
mixin _$PayrollTotals {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PayrollTotalsCopyWith<PayrollTotals> get copyWith =>
      _$PayrollTotalsCopyWithImpl<PayrollTotals>(
          this as PayrollTotals, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PayrollTotals &&
            (identical(other.workedSeconds, workedSeconds) ||
                other.workedSeconds == workedSeconds) &&
            (identical(other.shiftsCount, shiftsCount) ||
                other.shiftsCount == shiftsCount) &&
...
abstract mixin class $PayrollTotalsCopyWith<$Res> {
  factory $PayrollTotalsCopyWith(
          PayrollTotals value, $Res Function(PayrollTotals) _then) =
      _$PayrollTotalsCopyWithImpl;
  @useResult
...
extension PayrollTotalsPatterns on PayrollTotals {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PayrollTotals value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _PayrollTotals implements PayrollTotals {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PayrollTotalsCopyWith<_PayrollTotals> get copyWith =>
      __$PayrollTotalsCopyWithImpl<_PayrollTotals>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PayrollTotals &&
            (identical(other.workedSeconds, workedSeconds) ||
                other.workedSeconds == workedSeconds) &&
            (identical(other.shiftsCount, shiftsCount) ||
                other.shiftsCount == shiftsCount) &&
...
/// @nodoc
abstract mixin class _$PayrollTotalsCopyWith<$Res>
    implements $PayrollTotalsCopyWith<$Res> {
  factory _$PayrollTotalsCopyWith(
          _PayrollTotals value, $Res Function(_PayrollTotals) _then) =
      __$PayrollTotalsCopyWithImpl;
  @override
  @useResult
  $Res call({int workedSeconds, int shiftsCount, int grossAmountMinor});
}
...
mixin _$Payroll {
  ...
  String get currency;
  List<PayrollItem> get items;
  PayrollTotals get totals;

  /// Create a copy of Payroll
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PayrollCopyWith<Payroll> get copyWith =>
      _$PayrollCopyWithImpl<Payroll>(this as Payroll, _$identity);
...
abstract mixin class $PayrollCopyWith<$Res> {
  factory $PayrollCopyWith(Payroll value, $Res Function(Payroll) _then) =
      _$PayrollCopyWithImpl;
  @useResult
  $Res call(
...
/// @nodoc
class _$PayrollCopyWithImpl<$Res> implements $PayrollCopyWith<$Res> {
...
extension PayrollPatterns on Payroll {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Payroll value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(PayrollPeriod period, String currency,
            List<PayrollItem> items, PayrollTotals totals)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _Payroll implements Payroll {
  const _Payroll(
      ...
      required final List<PayrollItem> items,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PayrollCopyWith<_Payroll> get copyWith =>
      __$PayrollCopyWithImpl<_Payroll>(this, _$identity);
...
abstract mixin class _$PayrollCopyWith<$Res> implements $PayrollCopyWith<$Res> {
  factory _$PayrollCopyWith(_Payroll value, $Res Function(_Payroll) _then) =
      __$PayrollCopyWithImpl;
  @override
  @useResult
  $Res call(
      {PayrollPeriod period,
...
/// @nodoc
class __$PayrollCopyWithImpl<$Res> implements _$PayrollCopyWith<$Res> {
