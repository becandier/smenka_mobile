...
mixin _$JoinResult {
  ...
  $JoinResultCopyWith<JoinResult> get copyWith =>
      _$JoinResultCopyWithImpl<JoinResult>(this as JoinResult, _$identity);
...
abstract mixin class $JoinResultCopyWith<$Res> {
  factory $JoinResultCopyWith(
          JoinResult value, $Res Function(JoinResult) _then) =
      _$JoinResultCopyWithImpl;
  @useResult
  $Res call({String organizationId, String organizationName, String role});
}

/// @nodoc
class _$JoinResultCopyWithImpl<$Res> implements $JoinResultCopyWith<$Res> {
...
extension JoinResultPatterns on JoinResult {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_JoinResult value)? $default, {
...
class _JoinResult implements JoinResult {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$JoinResultCopyWith<_JoinResult> get copyWith =>
      __$JoinResultCopyWithImpl<_JoinResult>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _JoinResult &&
            (identical(other.organizationId, organizationId) ||
                other.organizationId == organizationId) &&
            (identical(other.organizationName, organizationName) ||
                other.organizationName == organizationName) &&
...
/// @nodoc
abstract mixin class _$JoinResultCopyWith<$Res>
    implements $JoinResultCopyWith<$Res> {
  factory _$JoinResultCopyWith(
          _JoinResult value, $Res Function(_JoinResult) _then) =
      __$JoinResultCopyWithImpl;
  @override
  @useResult
  $Res call({String organizationId, String organizationName, String role});
}
...
/// @nodoc
class __$JoinResultCopyWithImpl<$Res> implements _$JoinResultCopyWith<$Res> {
