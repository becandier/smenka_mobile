...
abstract mixin class $OrgSettingsCopyWith<$Res>  {
  factory $OrgSettingsCopyWith(OrgSettings value, $Res Function(OrgSettings) _then) = _$OrgSettingsCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$OrgSettingsCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _OrgSettings value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _OrgSettings value)  $default,){
final _that = this;
switch (_that) {
case _OrgSettings():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _OrgSettings value)?  $default,){
final _that = this;
switch (_that) {
case _OrgSettings() when $default != null:
return $default(_that);case _:
...
class _OrgSettings implements OrgSettings {
  const _OrgSettings({required this.organizationId, required this.geoCheckEnabled, this.autoFinishHours, this.maxPauseMinutes, this.maxPausesPerShift});
...
@pragma('vm:prefer-inline')
_$OrgSettingsCopyWith<_OrgSettings> get copyWith => __$OrgSettingsCopyWithImpl<_OrgSettings>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrgSettings&&(identical(other.organizationId, organizationId) || other.organizationId == organizationId)&&(identical(other.geoCheckEnabled, geoCheckEnabled) || other.geoCheckEnabled == geoCheckEnabled)&&(identical(other.autoFinishHours, autoFinishHours) || other.autoFinishHours == autoFinishHours)&&(identical(other.maxPauseMinutes, maxPauseMinutes) || other.maxPauseMinutes == maxPauseMinutes)&&(identical(other.maxPausesPerShift, maxPausesPerShift) || other.maxPausesPerShift == maxPausesPerShift));
}
...
/// @nodoc
abstract mixin class _$OrgSettingsCopyWith<$Res> implements $OrgSettingsCopyWith<$Res> {
  factory _$OrgSettingsCopyWith(_OrgSettings value, $Res Function(_OrgSettings) _then) = __$OrgSettingsCopyWithImpl;
@override @useResult
$Res call({
 String organizationId, bool geoCheckEnabled, int? autoFinishHours, int? maxPauseMinutes, int? maxPausesPerShift
});
...
/// @nodoc
class __$OrgSettingsCopyWithImpl<$Res>
    implements _$OrgSettingsCopyWith<$Res> {
