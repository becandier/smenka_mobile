...
mixin _$Organization {
 ...
 String get id; String get name; String get ownerId; String get inviteCode; bool get isDeleted; DateTime get createdAt; bool get geoCheckEnabled;/// Требовать привязку рабочей точки к смене. При гео-проверке точка
/// определяется сервером; при выключенной гео — выбирается сотрудником
/// (обязательно, если флаг включён).
 bool get requireWorkLocation;/// IANA-таймзона организации (`Europe/Moscow`, …) — плановое время
...
/// устаревшего кэша без поля.
 String get timezone; OrgMembershipRole? get myRole; OrganizationRole? get myCustomRole;
...
@override
String toString() {
  return 'Organization(id: $id, name: $name, ownerId: $ownerId, inviteCode: $inviteCode, isDeleted: $isDeleted, createdAt: $createdAt, geoCheckEnabled: $geoCheckEnabled, requireWorkLocation: $requireWorkLocation, timezone: $timezone, myRole: $myRole, myCustomRole: $myCustomRole)';
}
...
@useResult
$Res call({
 String id, String name, String ownerId, String inviteCode, bool isDeleted, DateTime createdAt, bool geoCheckEnabled, bool requireWorkLocation, String timezone, OrgMembershipRole? myRole, OrganizationRole? myCustomRole
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String ownerId,  String inviteCode,  bool isDeleted,  DateTime createdAt,  bool geoCheckEnabled,  bool requireWorkLocation,  String timezone,  OrgMembershipRole? myRole,  OrganizationRole? myCustomRole)  $default,) {final _that = this;
switch (_that) {
case _Organization():
return $default(_that.id,_that.name,_that.ownerId,_that.inviteCode,_that.isDeleted,_that.createdAt,_that.geoCheckEnabled,_that.requireWorkLocation,_that.timezone,_that.myRole,_that.myCustomRole);case _:
  throw StateError('Unexpected subclass');
...
class _Organization implements Organization {
  const _Organization({required this.id, required this.name, required this.ownerId, required this.inviteCode, required this.isDeleted, required this.createdAt, this.geoCheckEnabled = false, this.requireWorkLocation = false, this.timezone = 'Europe/Moscow', this.myRole, this.myCustomRole});
...
@override $OrganizationRoleCopyWith<$Res>? get myCustomRole;
