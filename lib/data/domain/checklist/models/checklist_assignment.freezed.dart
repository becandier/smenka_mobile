...
mixin _$ChecklistAssignedUser {
  ...
  $ChecklistAssignedUserCopyWith<ChecklistAssignedUser> get copyWith =>
      _$ChecklistAssignedUserCopyWithImpl<ChecklistAssignedUser>(
          this as ChecklistAssignedUser, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ChecklistAssignedUser &&
...
abstract mixin class $ChecklistAssignedUserCopyWith<$Res> {
  factory $ChecklistAssignedUserCopyWith(ChecklistAssignedUser value,
          $Res Function(ChecklistAssignedUser) _then) =
      _$ChecklistAssignedUserCopyWithImpl;
  @useResult
...
extension ChecklistAssignedUserPatterns on ChecklistAssignedUser {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ChecklistAssignedUser value)? $default, {
...
class _ChecklistAssignedUser implements ChecklistAssignedUser {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChecklistAssignedUserCopyWith<_ChecklistAssignedUser> get copyWith =>
      __$ChecklistAssignedUserCopyWithImpl<_ChecklistAssignedUser>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ChecklistAssignedUser &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.userName, userName) ||
                other.userName == userName) &&
            (identical(other.userEmail, userEmail) ||
...
/// @nodoc
abstract mixin class _$ChecklistAssignedUserCopyWith<$Res>
    implements $ChecklistAssignedUserCopyWith<$Res> {
  factory _$ChecklistAssignedUserCopyWith(_ChecklistAssignedUser value,
          $Res Function(_ChecklistAssignedUser) _then) =
      __$ChecklistAssignedUserCopyWithImpl;
  @override
  @useResult
  $Res call({String userId, String userName, String userEmail});
}
...
mixin _$ChecklistAssignment {
  ...
  List<ChecklistAssignedUser> get personalAdd;
  List<ChecklistAssignedUser> get personalRemove;

  /// Create a copy of ChecklistAssignment
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ChecklistAssignmentCopyWith<ChecklistAssignment> get copyWith =>
      _$ChecklistAssignmentCopyWithImpl<ChecklistAssignment>(
          this as ChecklistAssignment, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ChecklistAssignment &&
...
abstract mixin class $ChecklistAssignmentCopyWith<$Res> {
  factory $ChecklistAssignmentCopyWith(
          ChecklistAssignment value, $Res Function(ChecklistAssignment) _then) =
      _$ChecklistAssignmentCopyWithImpl;
  @useResult
  $Res call(
      {String templateId,
      List<String> roleIds,
      List<ChecklistAssignedUser> personalAdd,
      List<ChecklistAssignedUser> personalRemove});
}
...
extension ChecklistAssignmentPatterns on ChecklistAssignment {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ChecklistAssignment value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _ChecklistAssignment implements ChecklistAssignment {
  const _ChecklistAssignment(
      {required this.templateId,
      required final List<String> roleIds,
      required final List<ChecklistAssignedUser> personalAdd,
      required final List<ChecklistAssignedUser> personalRemove})
      : _roleIds = roleIds,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChecklistAssignmentCopyWith<_ChecklistAssignment> get copyWith =>
      __$ChecklistAssignmentCopyWithImpl<_ChecklistAssignment>(
          this, _$identity);
...
/// @nodoc
abstract mixin class _$ChecklistAssignmentCopyWith<$Res>
    implements $ChecklistAssignmentCopyWith<$Res> {
  factory _$ChecklistAssignmentCopyWith(_ChecklistAssignment value,
          $Res Function(_ChecklistAssignment) _then) =
      __$ChecklistAssignmentCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String templateId,
