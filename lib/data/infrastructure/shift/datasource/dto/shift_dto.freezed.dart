...
mixin _$ShiftOvertimeRequestDto {
 ...
 String get id; int get minutes; String get status; String get comment; String? get reviewComment; DateTime? get reviewedAt; DateTime get createdAt;
...
@override
String toString() {
  return 'ShiftOvertimeRequestDto(id: $id, minutes: $minutes, status: $status, comment: $comment, reviewComment: $reviewComment, reviewedAt: $reviewedAt, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, int minutes, String status, String comment, String? reviewComment, DateTime? reviewedAt, DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  int minutes,  String status,  String comment,  String? reviewComment,  DateTime? reviewedAt,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShiftOvertimeRequestDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  int minutes,  String status,  String comment,  String? reviewComment,  DateTime? reviewedAt,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _ShiftOvertimeRequestDto():
return $default(_that.id,_that.minutes,_that.status,_that.comment,_that.reviewComment,_that.reviewedAt,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  int minutes,  String status,  String comment,  String? reviewComment,  DateTime? reviewedAt,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _ShiftOvertimeRequestDto() when $default != null:
return $default(_that.id,_that.minutes,_that.status,_that.comment,_that.reviewComment,_that.reviewedAt,_that.createdAt);case _:
  return null;
...
class _ShiftOvertimeRequestDto implements ShiftOvertimeRequestDto {
  const _ShiftOvertimeRequestDto({required this.id, required this.minutes, required this.status, required this.comment, this.reviewComment, this.reviewedAt, required this.createdAt});
...
/// бэк/персональная смена не шлёт → `null`.
 String? get workScheduleId; String? get scheduleName; DateTime? get scheduledStartAt; DateTime? get scheduledEndAt; int? get lateSeconds; String? get finishReason; ShiftOvertimeRequestDto? get overtime;
