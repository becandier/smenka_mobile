...
$ShiftStatsDtoCopyWith<ShiftStatsDto> get copyWith => _$ShiftStatsDtoCopyWithImpl<ShiftStatsDto>(this as ShiftStatsDto, _$identity);
...
abstract mixin class $ShiftStatsDtoCopyWith<$Res>  {
  factory $ShiftStatsDtoCopyWith(ShiftStatsDto value, $Res Function(ShiftStatsDto) _then) = _$ShiftStatsDtoCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ShiftStatsDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ShiftStatsDto value)  $default,){
final _that = this;
switch (_that) {
case _ShiftStatsDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ShiftStatsDto value)?  $default,){
final _that = this;
switch (_that) {
case _ShiftStatsDto() when $default != null:
return $default(_that);case _:
...
class _ShiftStatsDto implements ShiftStatsDto {
  const _ShiftStatsDto({required this.totalWorkedSeconds, required this.shiftCount, required this.averageShiftSeconds, this.period, this.rangeFrom, this.rangeTo});
  factory _ShiftStatsDto.fromJson(Map<String, dynamic> json) => _$ShiftStatsDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$ShiftStatsDtoCopyWith<_ShiftStatsDto> get copyWith => __$ShiftStatsDtoCopyWithImpl<_ShiftStatsDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ShiftStatsDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ShiftStatsDto&&(identical(other.totalWorkedSeconds, totalWorkedSeconds) || other.totalWorkedSeconds == totalWorkedSeconds)&&(identical(other.shiftCount, shiftCount) || other.shiftCount == shiftCount)&&(identical(other.averageShiftSeconds, averageShiftSeconds) || other.averageShiftSeconds == averageShiftSeconds)&&(identical(other.period, period) || other.period == period)&&(identical(other.rangeFrom, rangeFrom) || other.rangeFrom == rangeFrom)&&(identical(other.rangeTo, rangeTo) || other.rangeTo == rangeTo));
}
...
/// @nodoc
abstract mixin class _$ShiftStatsDtoCopyWith<$Res> implements $ShiftStatsDtoCopyWith<$Res> {
  factory _$ShiftStatsDtoCopyWith(_ShiftStatsDto value, $Res Function(_ShiftStatsDto) _then) = __$ShiftStatsDtoCopyWithImpl;
@override @useResult
$Res call({
 int totalWorkedSeconds, int shiftCount, int averageShiftSeconds, String? period, DateTime? rangeFrom, DateTime? rangeTo
});
