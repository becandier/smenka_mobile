...
mixin _$UserDto {
  ...
  @override
  String toString() {
    return 'UserDto(id: $id, email: $email, name: $name, avatarUrl: $avatarUrl)';
  }
}
...
abstract mixin class $UserDtoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String email, String name, String? avatarUrl});
}
...
extension UserDtoPatterns on UserDto {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String email, String name, String? avatarUrl)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
