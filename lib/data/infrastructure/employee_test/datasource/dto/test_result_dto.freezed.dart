...
mixin _$TestResultDto {
 ...
 int get score; int get maxScore; int get percent; bool get passed; int get passThresholdPercent; int get attemptsUsed; int get attemptsLeft; bool get revealAnswers; List<TestAttemptQuestionDto>? get questions;
...
@override
String toString() {
  return 'TestResultDto(score: $score, maxScore: $maxScore, percent: $percent, passed: $passed, passThresholdPercent: $passThresholdPercent, attemptsUsed: $attemptsUsed, attemptsLeft: $attemptsLeft, revealAnswers: $revealAnswers, questions: $questions)';
}
...
@useResult
$Res call({
 int score, int maxScore, int percent, bool passed, int passThresholdPercent, int attemptsUsed, int attemptsLeft, bool revealAnswers, List<TestAttemptQuestionDto>? questions
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int score,  int maxScore,  int percent,  bool passed,  int passThresholdPercent,  int attemptsUsed,  int attemptsLeft,  bool revealAnswers,  List<TestAttemptQuestionDto>? questions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TestResultDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int score,  int maxScore,  int percent,  bool passed,  int passThresholdPercent,  int attemptsUsed,  int attemptsLeft,  bool revealAnswers,  List<TestAttemptQuestionDto>? questions)  $default,) {final _that = this;
switch (_that) {
case _TestResultDto():
return $default(_that.score,_that.maxScore,_that.percent,_that.passed,_that.passThresholdPercent,_that.attemptsUsed,_that.attemptsLeft,_that.revealAnswers,_that.questions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int score,  int maxScore,  int percent,  bool passed,  int passThresholdPercent,  int attemptsUsed,  int attemptsLeft,  bool revealAnswers,  List<TestAttemptQuestionDto>? questions)?  $default,) {final _that = this;
switch (_that) {
case _TestResultDto() when $default != null:
return $default(_that.score,_that.maxScore,_that.percent,_that.passed,_that.passThresholdPercent,_that.attemptsUsed,_that.attemptsLeft,_that.revealAnswers,_that.questions);case _:
  return null;
...
class _TestResultDto implements TestResultDto {
  const _TestResultDto({required this.score, required this.maxScore, required this.percent, required this.passed, required this.passThresholdPercent, required this.attemptsUsed, required this.attemptsLeft, this.revealAnswers = false, final  List<TestAttemptQuestionDto>? questions}): _questions = questions;
...
@override@JsonKey() final  bool revealAnswers;
 final  List<TestAttemptQuestionDto>? _questions;
@override List<TestAttemptQuestionDto>? get questions {
