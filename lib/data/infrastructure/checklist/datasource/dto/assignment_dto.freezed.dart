...
mixin _$ChecklistAssignedUserDto {
  ...
  $ChecklistAssignedUserDtoCopyWith<ChecklistAssignedUserDto> get copyWith =>
      _$ChecklistAssignedUserDtoCopyWithImpl<ChecklistAssignedUserDto>(
          this as ChecklistAssignedUserDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ChecklistAssignedUserDto &&
...
abstract mixin class $ChecklistAssignedUserDtoCopyWith<$Res> {
  factory $ChecklistAssignedUserDtoCopyWith(ChecklistAssignedUserDto value,
          $Res Function(ChecklistAssignedUserDto) _then) =
      _$ChecklistAssignedUserDtoCopyWithImpl;
  @useResult
...
extension ChecklistAssignedUserDtoPatterns on ChecklistAssignedUserDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ChecklistAssignedUserDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ChecklistAssignedUserDto() when $default != null:
        return $default(_that.userId, _that.userName, _that.userEmail);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String userId, String userName, String userEmail) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _ChecklistAssignedUserDto():
...
class _ChecklistAssignedUserDto implements ChecklistAssignedUserDto {
  const _ChecklistAssignedUserDto(
      {required this.userId, required this.userName, required this.userEmail});
  factory _ChecklistAssignedUserDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChecklistAssignedUserDtoCopyWith<_ChecklistAssignedUserDto> get copyWith =>
      __$ChecklistAssignedUserDtoCopyWithImpl<_ChecklistAssignedUserDto>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChecklistAssignedUserDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ChecklistAssignedUserDto &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.userName, userName) ||
                other.userName == userName) &&
            (identical(other.userEmail, userEmail) ||
...
/// @nodoc
abstract mixin class _$ChecklistAssignedUserDtoCopyWith<$Res>
    implements $ChecklistAssignedUserDtoCopyWith<$Res> {
  factory _$ChecklistAssignedUserDtoCopyWith(_ChecklistAssignedUserDto value,
          $Res Function(_ChecklistAssignedUserDto) _then) =
      __$ChecklistAssignedUserDtoCopyWithImpl;
  @override
  @useResult
  $Res call({String userId, String userName, String userEmail});
}
...
mixin _$ChecklistAssignmentDto {
  ...
  List<ChecklistAssignedUserDto> get personalAdd;
  List<ChecklistAssignedUserDto> get personalRemove;

  /// Create a copy of ChecklistAssignmentDto
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ChecklistAssignmentDtoCopyWith<ChecklistAssignmentDto> get copyWith =>
      _$ChecklistAssignmentDtoCopyWithImpl<ChecklistAssignmentDto>(
          this as ChecklistAssignmentDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ChecklistAssignmentDto &&
            (identical(other.templateId, templateId) ||
                other.templateId == templateId) &&
            const DeepCollectionEquality().equals(other.roleIds, roleIds) &&
            const DeepCollectionEquality()
                .equals(other.personalAdd, personalAdd) &&
            const DeepCollectionEquality()
                .equals(other.personalRemove, personalRemove));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(personalAdd),
      const DeepCollectionEquality().hash(personalRemove));
...
abstract mixin class $ChecklistAssignmentDtoCopyWith<$Res> {
  factory $ChecklistAssignmentDtoCopyWith(ChecklistAssignmentDto value,
          $Res Function(ChecklistAssignmentDto) _then) =
      _$ChecklistAssignmentDtoCopyWithImpl;
  @useResult
  $Res call(
      {String templateId,
      List<String> roleIds,
      List<ChecklistAssignedUserDto> personalAdd,
      List<ChecklistAssignedUserDto> personalRemove});
}
...
class _$ChecklistAssignmentDtoCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? roleIds = null,
    Object? personalAdd = null,
    Object? personalRemove = null,
  }) {
    return _then(_self.copyWith(
      ...
      roleIds: null == roleIds
          ...
          : roleIds // ignore: cast_nullable_to_non_nullable
              as List<String>,
      personalAdd: null == personalAdd
          ? _self.personalAdd
          : personalAdd // ignore: cast_nullable_to_non_nullable
              as List<ChecklistAssignedUserDto>,
      personalRemove: null == personalRemove
          ? _self.personalRemove
          : personalRemove // ignore: cast_nullable_to_non_nullable
              as List<ChecklistAssignedUserDto>,
    ));
  }
}
...
extension ChecklistAssignmentDtoPatterns on ChecklistAssignmentDto {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ChecklistAssignmentDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ChecklistAssignmentDto() when $default != null:
        return $default(_that.templateId, _that.roleIds, _that.personalAdd,
            _that.personalRemove);
      case _:
        return orElse();
    }
  }
...
class _ChecklistAssignmentDto implements ChecklistAssignmentDto {
  const _ChecklistAssignmentDto(
      {required this.templateId,
      required final List<String> roleIds,
      required final List<ChecklistAssignedUserDto> personalAdd,
      required final List<ChecklistAssignedUserDto> personalRemove})
      : _roleIds = roleIds,
        _personalAdd = personalAdd,
        _personalRemove = personalRemove;
  factory _ChecklistAssignmentDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChecklistAssignmentDtoCopyWith<_ChecklistAssignmentDto> get copyWith =>
      __$ChecklistAssignmentDtoCopyWithImpl<_ChecklistAssignmentDto>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChecklistAssignmentDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ChecklistAssignmentDto &&
            (identical(other.templateId, templateId) ||
                other.templateId == templateId) &&
            const DeepCollectionEquality().equals(other._roleIds, _roleIds) &&
            const DeepCollectionEquality()
                .equals(other._personalAdd, _personalAdd) &&
            const DeepCollectionEquality()
                .equals(other._personalRemove, _personalRemove));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_personalAdd),
      const DeepCollectionEquality().hash(_personalRemove));
...
/// @nodoc
abstract mixin class _$ChecklistAssignmentDtoCopyWith<$Res>
    implements $ChecklistAssignmentDtoCopyWith<$Res> {
  factory _$ChecklistAssignmentDtoCopyWith(_ChecklistAssignmentDto value,
          $Res Function(_ChecklistAssignmentDto) _then) =
      __$ChecklistAssignmentDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String templateId,
