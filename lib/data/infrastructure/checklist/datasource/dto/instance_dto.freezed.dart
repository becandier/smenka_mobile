...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChecklistItemsSummaryDto&&(identical(other.total, total) || other.total == total)&&(identical(other.completed, completed) || other.completed == completed));
}
...
class _ChecklistItemsSummaryDto implements ChecklistItemsSummaryDto {
  const _ChecklistItemsSummaryDto({required this.total, required this.completed});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChecklistItemsSummaryDto&&(identical(other.total, total) || other.total == total)&&(identical(other.completed, completed) || other.completed == completed));
}
...
mixin _$ChecklistInstanceDetailDto {
 ...
 String get id; String get name; String get type; bool get isRequired; String get status; DateTime get createdAt; List<ChecklistInstanceItemDto> get items; DateTime? get completedAt;
...
@useResult
$Res call({
 String id, String name, String type, bool isRequired, String status, DateTime createdAt, List<ChecklistInstanceItemDto> items, DateTime? completedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String type,  bool isRequired,  String status,  DateTime createdAt,  List<ChecklistInstanceItemDto> items,  DateTime? completedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChecklistInstanceDetailDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String type,  bool isRequired,  String status,  DateTime createdAt,  List<ChecklistInstanceItemDto> items,  DateTime? completedAt)  $default,) {final _that = this;
switch (_that) {
case _ChecklistInstanceDetailDto():
return $default(_that.id,_that.name,_that.type,_that.isRequired,_that.status,_that.createdAt,_that.items,_that.completedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String type,  bool isRequired,  String status,  DateTime createdAt,  List<ChecklistInstanceItemDto> items,  DateTime? completedAt)?  $default,) {final _that = this;
switch (_that) {
case _ChecklistInstanceDetailDto() when $default != null:
return $default(_that.id,_that.name,_that.type,_that.isRequired,_that.status,_that.createdAt,_that.items,_that.completedAt);case _:
  return null;
...
class _ChecklistInstanceDetailDto implements ChecklistInstanceDetailDto {
  const _ChecklistInstanceDetailDto({required this.id, required this.name, required this.type, required this.isRequired, required this.status, required this.createdAt, required final  List<ChecklistInstanceItemDto> items, this.completedAt}): _items = items;
...
class _ChecklistInstanceItemDto implements ChecklistInstanceItemDto {
  const _ChecklistInstanceItemDto({required this.id, required this.text, required this.isRequired, required this.position, required this.isCompleted, required this.changeCount, this.comment, this.completedAt});
