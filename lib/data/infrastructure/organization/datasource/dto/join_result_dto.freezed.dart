...
$JoinResultDtoCopyWith<JoinResultDto> get copyWith => _$JoinResultDtoCopyWithImpl<JoinResultDto>(this as JoinResultDto, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is JoinResultDto&&(identical(other.organizationId, organizationId) || other.organizationId == organizationId)&&(identical(other.organizationName, organizationName) || other.organizationName == organizationName)&&(identical(other.role, role) || other.role == role));
}
...
abstract mixin class $JoinResultDtoCopyWith<$Res>  {
  factory $JoinResultDtoCopyWith(JoinResultDto value, $Res Function(JoinResultDto) _then) = _$JoinResultDtoCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _JoinResultDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _JoinResultDto value)  $default,){
final _that = this;
switch (_that) {
case _JoinResultDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _JoinResultDto value)?  $default,){
final _that = this;
switch (_that) {
case _JoinResultDto() when $default != null:
return $default(_that);case _:
...
class _JoinResultDto implements JoinResultDto {
  const _JoinResultDto({required this.organizationId, required this.organizationName, required this.role});
  factory _JoinResultDto.fromJson(Map<String, dynamic> json) => _$JoinResultDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$JoinResultDtoCopyWith<_JoinResultDto> get copyWith => __$JoinResultDtoCopyWithImpl<_JoinResultDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$JoinResultDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _JoinResultDto&&(identical(other.organizationId, organizationId) || other.organizationId == organizationId)&&(identical(other.organizationName, organizationName) || other.organizationName == organizationName)&&(identical(other.role, role) || other.role == role));
}
...
/// @nodoc
abstract mixin class _$JoinResultDtoCopyWith<$Res> implements $JoinResultDtoCopyWith<$Res> {
  factory _$JoinResultDtoCopyWith(_JoinResultDto value, $Res Function(_JoinResultDto) _then) = __$JoinResultDtoCopyWithImpl;
@override @useResult
$Res call({
 String organizationId, String organizationName, String role
});
