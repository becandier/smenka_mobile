...
mixin _$OrganizationDto {
 ...
 String get id; String get name; String get ownerId; String get inviteCode; bool get isDeleted; DateTime get createdAt; bool get geoCheckEnabled; bool get requireWorkLocation; String get timezone; int get overtimeRequestDays; String? get myRole; OrganizationRoleDto? get myCustomRole; OrganizationSubscriptionDto? get subscription;
...
@useResult
$Res call({
 String id, String name, String ownerId, String inviteCode, bool isDeleted, DateTime createdAt, bool geoCheckEnabled, bool requireWorkLocation, String timezone, int overtimeRequestDays, String? myRole, OrganizationRoleDto? myCustomRole, OrganizationSubscriptionDto? subscription
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String ownerId,  String inviteCode,  bool isDeleted,  DateTime createdAt,  bool geoCheckEnabled,  bool requireWorkLocation,  String timezone,  int overtimeRequestDays,  String? myRole,  OrganizationRoleDto? myCustomRole,  OrganizationSubscriptionDto? subscription)  $default,) {final _that = this;
switch (_that) {
case _OrganizationDto():
return $default(_that.id,_that.name,_that.ownerId,_that.inviteCode,_that.isDeleted,_that.createdAt,_that.geoCheckEnabled,_that.requireWorkLocation,_that.timezone,_that.overtimeRequestDays,_that.myRole,_that.myCustomRole,_that.subscription);case _:
  throw StateError('Unexpected subclass');
