...
mixin _$OrganizationDto {
 ...
 String get id; String get name; String get ownerId; String get inviteCode; bool get isDeleted; DateTime get createdAt; bool get geoCheckEnabled; bool get requireWorkLocation; String get timezone; int get overtimeRequestDays; int? get checklistGraceMinutes; String? get myRole; OrganizationRoleDto? get myCustomRole; OrganizationSubscriptionDto? get subscription;
...
@useResult
$Res call({
 String id, String name, String ownerId, String inviteCode, bool isDeleted, DateTime createdAt, bool geoCheckEnabled, bool requireWorkLocation, String timezone, int overtimeRequestDays, int? checklistGraceMinutes, String? myRole, OrganizationRoleDto? myCustomRole, OrganizationSubscriptionDto? subscription
});


$OrganizationRoleDtoCopyWith<$Res>? get myCustomRole;$OrganizationSubscriptionDtoCopyWith<$Res>? get subscription;
...
as OrganizationRoleDto?,subscription: freezed == subscription ? _self.subscription : subscription // ignore: cast_nullable_to_non_nullable
as OrganizationSubscriptionDto?,
  ));
}
/// Create a copy of OrganizationDto
/// with the given fields replaced by the non-null parameter values.
...
@override
@pragma('vm:prefer-inline')
$OrganizationSubscriptionDtoCopyWith<$Res>? get subscription {
    if (_self.subscription == null) {
    return null;
  }

  return $OrganizationSubscriptionDtoCopyWith<$Res>(_self.subscription!, (value) {
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String ownerId,  String inviteCode,  bool isDeleted,  DateTime createdAt,  bool geoCheckEnabled,  bool requireWorkLocation,  String timezone,  int overtimeRequestDays,  int? checklistGraceMinutes,  String? myRole,  OrganizationRoleDto? myCustomRole,  OrganizationSubscriptionDto? subscription)  $default,) {final _that = this;
switch (_that) {
case _OrganizationDto():
return $default(_that.id,_that.name,_that.ownerId,_that.inviteCode,_that.isDeleted,_that.createdAt,_that.geoCheckEnabled,_that.requireWorkLocation,_that.timezone,_that.overtimeRequestDays,_that.checklistGraceMinutes,_that.myRole,_that.myCustomRole,_that.subscription);case _:
  throw StateError('Unexpected subclass');
...
@override final  OrganizationSubscriptionDto? subscription;
...
@override $OrganizationRoleDtoCopyWith<$Res>? get myCustomRole;@override $OrganizationSubscriptionDtoCopyWith<$Res>? get subscription;
