...
$PayrollPeriodDtoCopyWith<PayrollPeriodDto> get copyWith => _$PayrollPeriodDtoCopyWithImpl<PayrollPeriodDto>(this as PayrollPeriodDto, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PayrollPeriodDto&&(identical(other.dateFrom, dateFrom) || other.dateFrom == dateFrom)&&(identical(other.dateTo, dateTo) || other.dateTo == dateTo));
}
...
abstract mixin class $PayrollPeriodDtoCopyWith<$Res>  {
  factory $PayrollPeriodDtoCopyWith(PayrollPeriodDto value, $Res Function(PayrollPeriodDto) _then) = _$PayrollPeriodDtoCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PayrollPeriodDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PayrollPeriodDto value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PayrollPeriodDto value)?  $default,){
final _that = this;
switch (_that) {
case _PayrollPeriodDto() when $default != null:
return $default(_that);case _:
...
class _PayrollPeriodDto implements PayrollPeriodDto {
  ...
  factory _PayrollPeriodDto.fromJson(Map<String, dynamic> json) => _$PayrollPeriodDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$PayrollPeriodDtoCopyWith<_PayrollPeriodDto> get copyWith => __$PayrollPeriodDtoCopyWithImpl<_PayrollPeriodDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PayrollPeriodDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PayrollPeriodDto&&(identical(other.dateFrom, dateFrom) || other.dateFrom == dateFrom)&&(identical(other.dateTo, dateTo) || other.dateTo == dateTo));
}
...
/// @nodoc
abstract mixin class _$PayrollPeriodDtoCopyWith<$Res> implements $PayrollPeriodDtoCopyWith<$Res> {
  factory _$PayrollPeriodDtoCopyWith(_PayrollPeriodDto value, $Res Function(_PayrollPeriodDto) _then) = __$PayrollPeriodDtoCopyWithImpl;
@override @useResult
$Res call({
 DateTime? dateFrom, DateTime? dateTo
});
...
mixin _$PayrollItemDto {
 ...
 String get userId; String get userName; int get workedSeconds; int get shiftsCount; int get grossAmountMinor; int get unpaidSeconds; int get unpaidShiftsCount; bool get hasMissingRate; int get penaltyAmountMinor; int get penaltiesCount; int get netAmountMinor;
/// Create a copy of PayrollItemDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PayrollItemDtoCopyWith<PayrollItemDto> get copyWith => _$PayrollItemDtoCopyWithImpl<PayrollItemDto>(this as PayrollItemDto, _$identity);
...
abstract mixin class $PayrollItemDtoCopyWith<$Res>  {
  factory $PayrollItemDtoCopyWith(PayrollItemDto value, $Res Function(PayrollItemDto) _then) = _$PayrollItemDtoCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PayrollItemDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PayrollItemDto value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PayrollItemDto value)?  $default,){
final _that = this;
switch (_that) {
case _PayrollItemDto() when $default != null:
return $default(_that);case _:
...
class _PayrollItemDto implements PayrollItemDto {
  const _PayrollItemDto({required this.userId, required this.userName, required this.workedSeconds, required this.shiftsCount, required this.grossAmountMinor, required this.unpaidSeconds, required this.unpaidShiftsCount, required this.hasMissingRate, this.penaltyAmountMinor = 0, this.penaltiesCount = 0, this.netAmountMinor = 0});
  factory _PayrollItemDto.fromJson(Map<String, dynamic> json) => _$PayrollItemDtoFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$PayrollItemDtoCopyWith<_PayrollItemDto> get copyWith => __$PayrollItemDtoCopyWithImpl<_PayrollItemDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PayrollItemDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PayrollItemDto&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.userName, userName) || other.userName == userName)&&(identical(other.workedSeconds, workedSeconds) || other.workedSeconds == workedSeconds)&&(identical(other.shiftsCount, shiftsCount) || other.shiftsCount == shiftsCount)&&(identical(other.grossAmountMinor, grossAmountMinor) || other.grossAmountMinor == grossAmountMinor)&&(identical(other.unpaidSeconds, unpaidSeconds) || other.unpaidSeconds == unpaidSeconds)&&(identical(other.unpaidShiftsCount, unpaidShiftsCount) || other.unpaidShiftsCount == unpaidShiftsCount)&&(identical(other.hasMissingRate, hasMissingRate) || other.hasMissingRate == hasMissingRate)&&(identical(other.penaltyAmountMinor, penaltyAmountMinor) || other.penaltyAmountMinor == penaltyAmountMinor)&&(identical(other.penaltiesCount, penaltiesCount) || other.penaltiesCount == penaltiesCount)&&(identical(other.netAmountMinor, netAmountMinor) || other.netAmountMinor == netAmountMinor));
}
...
/// @nodoc
abstract mixin class _$PayrollItemDtoCopyWith<$Res> implements $PayrollItemDtoCopyWith<$Res> {
  factory _$PayrollItemDtoCopyWith(_PayrollItemDto value, $Res Function(_PayrollItemDto) _then) = __$PayrollItemDtoCopyWithImpl;
@override @useResult
$Res call({
 String userId, String userName, int workedSeconds, int shiftsCount, int grossAmountMinor, int unpaidSeconds, int unpaidShiftsCount, bool hasMissingRate, int penaltyAmountMinor, int penaltiesCount, int netAmountMinor
});
...
mixin _$PayrollTotalsDto {
 ...
 int get workedSeconds; int get shiftsCount; int get grossAmountMinor; int get penaltyAmountMinor; int get penaltiesCount; int get netAmountMinor;
/// Create a copy of PayrollTotalsDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PayrollTotalsDtoCopyWith<PayrollTotalsDto> get copyWith => _$PayrollTotalsDtoCopyWithImpl<PayrollTotalsDto>(this as PayrollTotalsDto, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PayrollTotalsDto&&(identical(other.workedSeconds, workedSeconds) || other.workedSeconds == workedSeconds)&&(identical(other.shiftsCount, shiftsCount) || other.shiftsCount == shiftsCount)&&(identical(other.grossAmountMinor, grossAmountMinor) || other.grossAmountMinor == grossAmountMinor)&&(identical(other.penaltyAmountMinor, penaltyAmountMinor) || other.penaltyAmountMinor == penaltyAmountMinor)&&(identical(other.penaltiesCount, penaltiesCount) || other.penaltiesCount == penaltiesCount)&&(identical(other.netAmountMinor, netAmountMinor) || other.netAmountMinor == netAmountMinor));
}
...
@override
String toString() {
  return 'PayrollTotalsDto(workedSeconds: $workedSeconds, shiftsCount: $shiftsCount, grossAmountMinor: $grossAmountMinor, penaltyAmountMinor: $penaltyAmountMinor, penaltiesCount: $penaltiesCount, netAmountMinor: $netAmountMinor)';
}
...
abstract mixin class $PayrollTotalsDtoCopyWith<$Res>  {
  factory $PayrollTotalsDtoCopyWith(PayrollTotalsDto value, $Res Function(PayrollTotalsDto) _then) = _$PayrollTotalsDtoCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PayrollTotalsDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PayrollTotalsDto value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PayrollTotalsDto value)?  $default,){
final _that = this;
switch (_that) {
case _PayrollTotalsDto() when $default != null:
return $default(_that);case _:
...
class _PayrollTotalsDto implements PayrollTotalsDto {
  const _PayrollTotalsDto({required this.workedSeconds, required this.shiftsCount, required this.grossAmountMinor, this.penaltyAmountMinor = 0, this.penaltiesCount = 0, this.netAmountMinor = 0});
  factory _PayrollTotalsDto.fromJson(Map<String, dynamic> json) => _$PayrollTotalsDtoFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$PayrollTotalsDtoCopyWith<_PayrollTotalsDto> get copyWith => __$PayrollTotalsDtoCopyWithImpl<_PayrollTotalsDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PayrollTotalsDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PayrollTotalsDto&&(identical(other.workedSeconds, workedSeconds) || other.workedSeconds == workedSeconds)&&(identical(other.shiftsCount, shiftsCount) || other.shiftsCount == shiftsCount)&&(identical(other.grossAmountMinor, grossAmountMinor) || other.grossAmountMinor == grossAmountMinor)&&(identical(other.penaltyAmountMinor, penaltyAmountMinor) || other.penaltyAmountMinor == penaltyAmountMinor)&&(identical(other.penaltiesCount, penaltiesCount) || other.penaltiesCount == penaltiesCount)&&(identical(other.netAmountMinor, netAmountMinor) || other.netAmountMinor == netAmountMinor));
}
...
/// @nodoc
abstract mixin class _$PayrollTotalsDtoCopyWith<$Res> implements $PayrollTotalsDtoCopyWith<$Res> {
  factory _$PayrollTotalsDtoCopyWith(_PayrollTotalsDto value, $Res Function(_PayrollTotalsDto) _then) = __$PayrollTotalsDtoCopyWithImpl;
@override @useResult
$Res call({
 int workedSeconds, int shiftsCount, int grossAmountMinor, int penaltyAmountMinor, int penaltiesCount, int netAmountMinor
});
...
mixin _$PayrollDto {
 ...
 PayrollPeriodDto get period; String get currency; List<PayrollItemDto> get items; PayrollTotalsDto get totals;
/// Create a copy of PayrollDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PayrollDtoCopyWith<PayrollDto> get copyWith => _$PayrollDtoCopyWithImpl<PayrollDto>(this as PayrollDto, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PayrollDto&&(identical(other.period, period) || other.period == period)&&(identical(other.currency, currency) || other.currency == currency)&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.totals, totals) || other.totals == totals));
}
...
abstract mixin class $PayrollDtoCopyWith<$Res>  {
  factory $PayrollDtoCopyWith(PayrollDto value, $Res Function(PayrollDto) _then) = _$PayrollDtoCopyWithImpl;
@useResult
$Res call({
 PayrollPeriodDto period, String currency, List<PayrollItemDto> items, PayrollTotalsDto totals
});


$PayrollPeriodDtoCopyWith<$Res> get period;$PayrollTotalsDtoCopyWith<$Res> get totals;

}
/// @nodoc
class _$PayrollDtoCopyWithImpl<$Res>
...
as List<PayrollItemDto>,totals: null == totals ? _self.totals : totals // ignore: cast_nullable_to_non_nullable
as PayrollTotalsDto,
  ));
}
/// Create a copy of PayrollDto
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PayrollDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PayrollDto value)  $default,){
final _that = this;
switch (_that) {
case _PayrollDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PayrollDto value)?  $default,){
final _that = this;
switch (_that) {
case _PayrollDto() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PayrollPeriodDto period,  String currency,  List<PayrollItemDto> items,  PayrollTotalsDto totals)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PayrollDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PayrollPeriodDto period,  String currency,  List<PayrollItemDto> items,  PayrollTotalsDto totals)  $default,) {final _that = this;
switch (_that) {
case _PayrollDto():
return $default(_that.period,_that.currency,_that.items,_that.totals);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PayrollPeriodDto period,  String currency,  List<PayrollItemDto> items,  PayrollTotalsDto totals)?  $default,) {final _that = this;
switch (_that) {
case _PayrollDto() when $default != null:
return $default(_that.period,_that.currency,_that.items,_that.totals);case _:
  return null;
...
class _PayrollDto implements PayrollDto {
  const _PayrollDto({required this.period, required this.currency, required final  List<PayrollItemDto> items, required this.totals}): _items = items;
  factory _PayrollDto.fromJson(Map<String, dynamic> json) => _$PayrollDtoFromJson(json);

@override final  PayrollPeriodDto period;
@override final  String currency;
 final  List<PayrollItemDto> _items;
@override List<PayrollItemDto> get items {
  if (_items is EqualUnmodifiableListView) return _items;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_items);
}

@override final  PayrollTotalsDto totals;

/// Create a copy of PayrollDto
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$PayrollDtoCopyWith<_PayrollDto> get copyWith => __$PayrollDtoCopyWithImpl<_PayrollDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PayrollDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PayrollDto&&(identical(other.period, period) || other.period == period)&&(identical(other.currency, currency) || other.currency == currency)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.totals, totals) || other.totals == totals));
}
...
/// @nodoc
abstract mixin class _$PayrollDtoCopyWith<$Res> implements $PayrollDtoCopyWith<$Res> {
  factory _$PayrollDtoCopyWith(_PayrollDto value, $Res Function(_PayrollDto) _then) = __$PayrollDtoCopyWithImpl;
@override @useResult
$Res call({
 PayrollPeriodDto period, String currency, List<PayrollItemDto> items, PayrollTotalsDto totals
});
...
@override $PayrollPeriodDtoCopyWith<$Res> get period;@override $PayrollTotalsDtoCopyWith<$Res> get totals;

}
/// @nodoc
class __$PayrollDtoCopyWithImpl<$Res>
    implements _$PayrollDtoCopyWith<$Res> {
